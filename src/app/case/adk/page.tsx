  ...
  return (
    <div className="relative min-h-screen overflow-x-clip">
      ...
      <CaseHeader
        ...
        title={
          <>
            I said it would rot. It shipped{" "}
            <span className="text-off">rotten.</span>
          </>
        }
        ...
        meta={[
          ["WHEN", "22 TO 28 AUGUST 2026"],
          ["FOUND", "WHILE BUILDING MIGRAGENT"],
          ["STATUS", "NOTHING MERGED YET"],
        ]}
      />
      ...
      <section className="relative z-10 mx-auto w-full max-w-6xl px-5 pb-24">
        <div className="space-y-14 lg:space-y-20">
          ...
          >
            <Readings
              items={SPLIT}
              note="8 + 22 + 3 = 33. The two I missed were modelArmorConfig and serviceTier, both top level."
            />
          </Clause>
        ...
        <CaseFoot
          ...
          nextHref="/case/calle"
          nextLabel="REPORT 03 :: CALL-E, MERGED"
        />
